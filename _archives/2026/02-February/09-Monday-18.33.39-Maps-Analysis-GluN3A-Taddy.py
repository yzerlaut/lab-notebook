...
plot_all(data='raw', 
         figname='OD-exp-raw-data-all.png')

# %%

plot_all(data='dFoF', 
         figname='OD-exp-dFoF-all.png')
...
if False:
    ...
    pil_img = ImageD(filename=\
                    os.path.join(NB_path, 'OD-exp-raw-data-all.png'))
    display(pil_img)
...
fig.savefig(os.path.join(NB_path, 'OD-exp-Preprocessing.png'),
            transparent=True)
...
fig.savefig(os.path.join(NB_path, 'OD-exp-summary-1.png'),
            transparent=False)
...
fig.savefig(os.path.join(NB_path, 'OD-exp-summary-2.png'),
            transparent=False)
...
fig.savefig(os.path.join(NB_path, 'OD-exp-summary.png'),
            transparent=False)
