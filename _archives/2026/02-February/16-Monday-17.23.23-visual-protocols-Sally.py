...
def DM(Screen, Nrepeat):
   return """{
    ...
    "N-repeat": %i,
    "-----------------------------------------------------------------2":0,
    "x-center-1": -80.0, "x-center-2": -20.0, "N-x-center": 5,
...
if True:
  build_movie(FD(Screen, 20), name='4-DIM-visual-information')

if 10:
  build_movie(FS(Screen, 20), name='flashed-stimuli', rm=False)
