...
# %%
dataFolder = os.path.join(os.path.expanduser('~'), 'DATA', 'Sally',
                        'Npx_WT_prelim_2026/ISI/02_02_2025')
...
# %%
# maps['down-phase-shifted'] = -np.pi/2.-.2*maps['up-phase-shifted']
maps['down-phase'] = 0*maps['up-phase']
maps['up-phase'] = 0*maps['up-phase']
# maps['down-phase'] = 3 - maps['down-phase']
compute_retinotopic_maps("", map_type='altitude', maps=maps,
                         phase_shift=2.5*np.pi/4.)
