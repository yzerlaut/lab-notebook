...
# %%
raw_data_path = \
    os.path.expanduser('/Volumes/YANN/ODI-GluN3A/2025_12_23')
smoothing = (2,2,2)
...
rsync -avhP --exclude "._*" --exclude "Imaging*" --exclude "NIdaq.*" --exclude "*Prelim*" /Volumes/YANN/ODI-GluN3A/* ~/DATA/Taddy/ODI-GluN3A
```
"""
