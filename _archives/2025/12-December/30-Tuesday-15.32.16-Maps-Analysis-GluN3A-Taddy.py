...
new_im.save(os.path.expanduser('~/Desktop/30-dec-2025-all-OD.png'))
from IPython.display import Image 
pil_img = Image(filename=os.path.expanduser('~/Desktop/30-dec-2025-all-OD.png'))
display(pil_img)
...
fig.savefig(os.path.expanduser('~/Desktop/30-dec-2025-summary-OD.png'),
            transparent=False)
